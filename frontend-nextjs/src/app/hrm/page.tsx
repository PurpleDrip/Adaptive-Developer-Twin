...
export default function HRMDashboard() {
  ...
  if (loading) return <div className="p-10 text-center animate-pulse">Scanning Organizational Vitals...</div>;

  return (
    <div className="grid grid-cols-12 gap-6 animate-fade">
      <div className="col-span-12 p-10 glass-card bg-gradient-to-r from-red-500/10 to-transparent">
        <h1 className="text-4xl font-bold mb-2 flex items-center gap-4">
          Organizational Health <ShieldCheck className="text-green-500" />
        </h1>
        <p className="text-gray-400">AI-driven attrition and burnout prevention across departments.</p>
      </div>

      <div className="col-span-12 lg:col-span-8 p-8 glass-card">
        <h3 className="text-lg font-bold mb-8">Attrition Risk Heatmap</h3>
        <div className="h-[300px]">
          {riskData.length > 0 ? (
            ...
            <div className="h-full flex items-center justify-center text-gray-600 italic">No risk assessments available.</div>
          )}
        </div>
      </div>
      ...
      <div className="col-span-12 lg:col-span-4 space-y-6">
        <div className="p-6 glass-card flex items-center gap-6">
          ...
          <div>
            <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Total Headcount</p>
        ...
        <div className="p-6 glass-card flex items-center gap-6 border-l-4 border-red-500/50">
          ...
          <div>
            <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">High Burnout Risk</p>
        ...
        <div className="p-6 glass-card flex items-center gap-6 border-l-4 border-green-500/50">
          ...
          <div>
            <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Avg Satisfaction</p>
